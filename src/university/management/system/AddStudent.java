...
public class AddStudent implements ActionListener{
    ...
    public AddStudent(){
        ...
        id15=new JLabel();
        id15.setBounds(0,0,1900,950);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/management/system/Icons/admission.jpg"));
        Image i3 = img.getImage().getScaledInstance(1900, 950,Image.SCALE_DEFAULT);
        ...
        id10= new JLabel("Class XII(%/CGPA)");
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"B.Tech","BCA","BBA","Bsc","MBA","MCA","M.Tech"};
